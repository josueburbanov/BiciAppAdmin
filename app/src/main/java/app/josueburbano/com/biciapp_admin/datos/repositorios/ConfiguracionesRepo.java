...
import app.josueburbano.com.biciapp_admin.datos.servicios.IServicioConfiguraciones;
...
public class ConfiguracionesRepo {
    ...
    public LiveData<List<ConfiguracionAdmin>> getConfiguraciones() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(app.josueburbano.com.biciapp_admin.datos.servicios.IServicioClientes.BASE_URL)
